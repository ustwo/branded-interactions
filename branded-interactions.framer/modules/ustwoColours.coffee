...
# 2.  Reference the contents by name. E.g: ustwoColours.piglet

# 3.  Optional: add this line to not have to use the ustwoColours prefix:
#     Utils.globalLayers ustwoColours
#     Now you can just reference each colour verbatim. E.g. piglet
